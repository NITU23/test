...
export default class News extends Component {
  ...
  async updateNews () {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b7821a64bf974bcba4ec36a6264ae09e&page=${this.state.page}&pageSize=${this.props.pageSize}`
